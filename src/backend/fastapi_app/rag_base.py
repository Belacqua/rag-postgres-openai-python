...
class RAGChatBase(ABC):
    ...
    def get_chat_params(self, messages: list[dict], overrides: ChatRequestOverrides) -> ChatParams:
    ...
    def prepare_rag_request(self, user_query, items: list[CapabilityPublic]) -> str:
